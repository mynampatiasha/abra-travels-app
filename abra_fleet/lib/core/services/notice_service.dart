  ...
  Future<NoticeItem> createNotice({
    ...
    try {
      ...
      final body = json.encode({
        ...
        'category': category,
        'priority': priority,
        'publishedBy': userId ?? 'unknown',
        'publishedByName': publishedByName ?? userName ?? 'Admin',
      });
