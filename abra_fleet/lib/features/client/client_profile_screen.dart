...
// Client Profile Screen with inline editing and photo upload
...
class _ClientProfileScreenState extends State<ClientProfileScreen> {
    ...
    try {
      ...
      try {
        ...
        await authRepo.updateUserProfile(
          ...
          // name: _nameController.text.trim(), // FIXME: Check surrounding context
          phoneNumber: phone,
        );
      } catch (e) {
  ...
  Widget _buildProfileContent() {
    final name = _profileData?['name'] as String? ?? 'Client';
    final email = _profileData?['email'] as String? ?? 'N/A';
    final role = _profileData?['role'] as String? ?? 'client';
