...
class ClientReportsAnalyticsWorking extends StatefulWidget {
  const ClientReportsAnalyticsWorking({Key? key}) : super(key: key);

  @override
  State<ClientReportsAnalyticsWorking> createState() => _ClientReportsAnalyticsWorkingState();
}

class _ClientReportsAnalyticsWorkingState extends State<ClientReportsAnalyticsWorking> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildRevenueItem('Today', '₹${_revenueStats['todayRevenue'] ?? 0}', Colors.green),
              _buildRevenueItem('Week', '₹${_revenueStats['weekRevenue'] ?? 0}', Colors.blue),
              _buildRevenueItem('Month', '₹${_revenueStats['monthRevenue'] ?? 0}', Colors.purple),
            ],
          ),
        ],
      ),
