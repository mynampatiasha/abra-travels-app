...
if (!empty($currentUserEmail)) {
    error_log("=== HR-KPI USER LOOKUP (Evaluate Team) ===");
...
// Lookup by email from database instead of hardcoded IDs
...
$is_admin = ($is_abishek || $is_keerthi || $is_managing_director || $is_management_dept || $is_hr_dept);
