...
// Create Models
const Invoice = mongoose.model('BillingInvoice', invoiceSchema);
const Bill = mongoose.model('BillingBill', billSchema);
const Transaction = mongoose.model('BillingTransaction', transactionSchema);
const Project = mongoose.model('BillingProject', projectSchema);
const BankAccount = mongoose.model('BillingBankAccount', bankAccountSchema);
const AccountWatchlist = mongoose.model('BillingAccountWatchlist', accountWatchlistSchema);
