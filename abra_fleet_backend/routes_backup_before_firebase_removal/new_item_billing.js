...
// All vendor and utility endpoints now return proper JSON format
// ============================================================================
...
// Create new item
router.post('/items', validateItemData, async (req, res) => {
  try {
    const itemData = {
...
// Update item
router.put('/items/:id', validateItemData, async (req, res) => {
  try {
    const updateData = {
      name: req.body.name.trim(),
      type: req.body.type,
...
// Get item statistics
router.get('/items/statistics', async (req, res) => {
  try {
...
router.post('/items/bulk-import', upload.single('file'), async (req, res) => {
  if (!req.file) {
...
// Get all vendors - Returns proper JSON format
router.get('/vendors', async (req, res) => {
  try {
    ...
    // Return in proper JSON format with vendors array
    res.json({
      success: true,
      vendors: vendors,
...
// Get units - Returns proper JSON format
router.get('/units', (req, res) => {
  res.json({
    success: true,
    units: ['pcs', 'dz', 'kg', 'ltr', 'box', 'carton', 'unit', 'dozen', 'gram', 'ton']
  });
});

// Get sales accounts - Returns proper JSON format
...
// Get purchase accounts - Returns proper JSON format
